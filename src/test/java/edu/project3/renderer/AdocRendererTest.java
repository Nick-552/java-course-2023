...
class AdocRendererTest {
    ...
    void render_shouldReturnCorrectAdocString_whenNormalInput(Report report, String renderExpected) {
        assertThat(new AdocRenderer().render(report)).isEqualTo(renderExpected);
    }
}
