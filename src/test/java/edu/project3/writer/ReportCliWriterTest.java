...
import static edu.project3.format.Format.MARKDOWN;
import static org.assertj.core.api.Assertions.assertThat;

class ReportCliWriterTest {

    public static Stream<Arguments> writerSource() {
        return Stream.of(
            Arguments.of(
                new Report(
                    "Header",
    ...
    void write(Report report, String expected) {
        ...
        assertThat(baos.toString().stripTrailing()).isEqualTo(expected);
        System.setOut(old);
    }
}
